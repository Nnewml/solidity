...
Documentation is inserted above each ``contract``, ``interface`` and
...
It can not start with a hyphen however. They can be used everywhere and are part of the developer documentation.
